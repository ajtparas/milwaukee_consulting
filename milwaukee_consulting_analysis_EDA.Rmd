...
ggplot(final, aes(x = BLD_TYPE))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()

#Appraiser Counts
ggplot(final, aes(x = APPRAISER))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()

# NBHD Counts
ggplot(final, aes(x = NBHD))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()

# Qual Counts
ggplot(final, aes(x = QUAL))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()

# COND Counts
ggplot(final, aes(x = COND))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()

# KITCHEN counts
ggplot(final, aes(x = KITCHEN_CT))+ geom_histogram(stat = "count", fill = "tomato2")

# Kitchen Rating counts
ggplot(final, aes(x = KITCHEN_RATING))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()

# Full Bath Counts
ggplot(final, aes(x = FULL_BATH_CT))+ geom_histogram(stat = "count", fill = "tomato2")

# Full Bath Ratings
ggplot(final, aes(x = FULL_BATH_RATING))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()

# Half Bath Counts
ggplot(final, aes(x = HALF_BATH_CT))+ geom_histogram(stat = "count", fill = "tomato2")

# Half Bath Ratings
ggplot(final, aes(x = HALF_BATH_RATING))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()

# Year Built Counts
ggplot(final, aes(x = YEAR_BUILT))+ geom_histogram(stat = "count", fill = "tomato2")+ xlim(1850,2021)

# Finished Area Counts
ggplot(final, aes(x = FINISHED_AREA))+ geom_histogram(stat = "count", fill = "tomato2") + xlim(0, 12059) + ylim(0,100)

# Land_SF counts
ggplot(final, aes(x = LAND_SF))+ geom_histogram(stat = "count", fill = "tomato2") + xlim(4000, 10000)+ ylim(0,100)
summary(final$LAND_SF)

# Houses Appealed in 2019
ggplot(final, aes(x = APPEALED19))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()

# Houses Appealed in 2020
ggplot(final, aes(x = APPEALED20))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()

# Houses Appealed in 2021
ggplot(final, aes(x = APPEALED21))+ geom_histogram(stat = "count", fill = "tomato2")+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + coord_flip()
```
